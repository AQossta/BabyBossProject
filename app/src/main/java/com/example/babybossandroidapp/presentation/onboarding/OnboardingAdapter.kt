...
import com.example.babybossandroidapp.data.model.OnboardingModel
import com.example.babybossandroidapp.databinding.ItemViewpagerOnboardingBinding
...
class OnboardingAdapter(): RecyclerView.Adapter<OnboardingAdapter.OnboardingViewHolder>() {
    ...
    inner class OnboardingViewHolder(private val binding: ItemViewpagerOnboardingBinding): RecyclerView.ViewHolder(binding.root){
        fun bindItem(onboardingModel: OnboardingModel){
            binding.tvTitleOnboardingFragment.text = onboardingModel.title
            binding.tvDescriptionOnboardingFragment.text = onboardingModel.description
            binding.imageViewOnboardingFragment.setImageResource(onboardingModel.imageId)
        }
    }
